...
# --- בניית מאגר המידע (מבוסס על הקבצים שהעלית) ---
...
study_materials = {
    "תרופות והחייאה": {
        ...
        * **חוק חשוב:** בחולים עם היפומגנזמיה והיפוקלמיה, יש לתקן מגנזיום תחילה.
        """,
        "אדרנלין (Adrenaline)": """
        **בהחייאה:**
        ...
        * מינון: 400 mcg/kg (מקס' 5 מ"ג).
        ...
        "אדנוזין (Adenosine)": """
        **התוויה:** SVT.
        **אופן מתן:** פוש מהיר + שטיפה מהירה (5-10 מ"ל סליין) בברז הכי קרוב ללב.
        **מינון:** מנה ראשונה 0.1 mg/kg (מקס' 6 מ"ג). מנה שנייה 0.2 mg/kg (מקס' 12 מ"ג).
        """,
        "סדציה ואינטובציה": """
        **מידזולם (דורמיקום):** מינון 0.1-0.05 mg/kg. אנטידוט: פלומזניל.
    ...
    "מצבי חירום ופרוטוקולים": {
        ...
        **שוק ספטי עמיד:** אם אין תגובה לנוזלים -> נוראדרנלין/אדרנלין.
        """,
        "שוק היפוולמי": """
        **סימנים:** טכיקרדיה (פיצוי ראשוני), מילוי קפילרי איטי, ירידה במתן שתן. ל"ד יורד רק בשלב מאוחר.
        ...
        **טיפול ב-ICP גבוה:** הרמת ראש 30 מעלות, סליין היפרטוני (3%) או מניטול, הנשמה עם PCO2 סביב 35-40.
        """
    },
...
if menu == "דף הבית":
    ...
    st.markdown("""
    מערכת זו מבוססת על הפרוטוקולים העדכניים של המחלקה (2025).
    **מה במערכת?**
